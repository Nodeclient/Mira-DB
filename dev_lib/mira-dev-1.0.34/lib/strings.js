...
module.exports = { 
    TAG:JQL_TAG,STRING:STRING_PARSE,SELECT_TABLE:SELECT_TABLE,SELECT_COLUMN:SELECT_COLUMN,SELECT_FIND:SELECT_FIND,SELECT_FIND_LIKE:SELECT_FIND_LIKE,SELECT_LIMIT:SELECT_LIMIT,SELECT_COUNT:SELECT_TABLE_COUNT,ADD_ROW:ADD_ROW,ADD_COLUMN:ADD_COLUMN,RENAME_TABLE:RENAME_TABLE,RENAME_COLUMN:RENAME_COLUMN,RENAME_DATABASE:RENAME_DATABASE,DROP_TABLE:DROP_TABLE,DROP_DATABASE:DROP_DATABASE,DELETE_COLUMN:DELETE_COLUMN,DELETE_ROW:DELETE_ROW,DELETE_INDEX:DELETE_ROW_INDEX,CREATE_TABLE:CREATE_TABLE,CREATE_DATABASE:CREATE_DATABASE,LIST_DATABASE:LIST_DATABASE,UPDATE_ROW:UPDATE_ROW,UNIQUE_COL:UNIQUE_COLUMN,LIST_TABLE:LIST_TABLE,JS:JQL_PARSE
}